...
public class Player {
    ...
    public void move(boolean[] input){
        ...
        bufferZones[1] = (boundary[1] - size/2.f < loc.x - speed && loc.x - speed < boundary[1]); // buffer zone
        bufferZones[2] = (boundary[2] - size/2.f < loc.y - speed && loc.y - speed < boundary[2]); // buffer zone  
